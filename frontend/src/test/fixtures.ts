  ...
  conflicts: [
    {
      ...
      left: {
        state: "available",
        version_id: "version-clinician-1",
        entry_id: "entry-clinician",
        entry_title: "Assessment and plan",
        entry_type: "clinician_note",
        owner_role: "clinician",
        trust_state: "clinician_confirmed",
        author: identities[0],
        version: 1,
        content: "Continue amoxicillin 500 mg twice daily.",
        content_hash: "a".repeat(64),
      ...
      right: {
        state: "available",
        version_id: "version-patient-1",
        entry_id: "entry-patient",
        entry_title: "Patient-reported medication",
        entry_type: "patient_insight",
        owner_role: "patient",
        trust_state: "patient_reported",
        author: identities[2],
        version: 1,
        content: "I take amoxicillin 250 mg twice daily.",
        content_hash: "b".repeat(64),
        source_is_current: false,
        created_at: "2026-08-26T08:04:00Z",
      },
      decision_policy:
        "No assertion is selected automatically. A clinician must inspect both immutable sources, document a rationale, and either confirm one assertion or escalate the contradiction.",
